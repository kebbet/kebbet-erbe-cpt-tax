...
namespace kebbet\erbe\cpt_tax\taxonomy\arttype\register;

use const kebbet\erbe\cpt_tax\taxonomy\arttype\TAXONOMY;
use const kebbet\erbe\cpt_tax\taxonomy\arttype\POST_TYPES;
...
function register() {
	$tax_labels = array(
		'name'                       => _x( 'Art type', 'taxonomy general name', 'kebbet-erbe-cpt-tax' ),
		'menu_name'                  => __( 'Art type', 'kebbet-erbe-cpt-tax' ),
		'singular_name'              => _x( 'Art type', 'taxonomy singular name', 'kebbet-erbe-cpt-tax' ),
		'all_items'                  => __( 'All art type tags', 'kebbet-erbe-cpt-tax' ),
		...
		'separate_items_with_commas' => __( 'Separate art type tags with commas', 'kebbet-erbe-cpt-tax' ),
