...
namespace kebbet\erbe\cpt_tax\taxonomy\artstatus\register;

use const kebbet\erbe\cpt_tax\taxonomy\artstatus\TAXONOMY;
use const kebbet\erbe\cpt_tax\taxonomy\artstatus\POST_TYPES;
...
function register() {
	$tax_labels = array(
		'name'                       => _x( 'Art status', 'taxonomy general name', 'kebbet-erbe-cpt-tax' ),
		'menu_name'                  => __( 'Art status', 'kebbet-erbe-cpt-tax' ),
		'singular_name'              => _x( 'Art status', 'taxonomy singular name', 'kebbet-erbe-cpt-tax' ),
		'all_items'                  => __( 'All art status tags', 'kebbet-erbe-cpt-tax' ),
		...
		'separate_items_with_commas' => __( 'Separate art status tags with commas', 'kebbet-erbe-cpt-tax' ),
