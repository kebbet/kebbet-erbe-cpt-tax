...
namespace kebbet\erbe\cpt_tax\taxonomy\artstatus\sorting;
...
function display_add_field() {
	...
	<div class="form-field term-sorting">
		<label for="<?php echo esc_attr( META_SLUG ); ?>"><?php esc_html_e( 'Numeric sorting value', 'kebbet-erbe-cpt-tax' ); ?></label>
		<input id="<?php echo esc_attr( META_SLUG ); ?>" name="<?php echo esc_attr( META_SLUG ); ?>" type="number" aria-describedby="sorting-description"/>
		<p id="sorting-description"><?php esc_html_e( 'Add a sorting number to the tags. On the front page, the tags are sorted from lowest number to highest.', 'kebbet-erbe-cpt-tax' ); ?></p>
	</div>
	<?php
}
...
function display_edit_field( $term ) {
	...
	<tr class="form-field term-group-wrap">
		<th scope="row"><label for="<?php echo esc_attr( META_SLUG ); ?>"><?php esc_html_e( 'Numeric sorting value', 'kebbet-erbe-cpt-tax' ); ?></label></th>
		<td>
			...
			<p id="sorting-description" class="description"><?php esc_html_e( 'Add a sorting number to the tag. On the front page, the tags are sorted from lowest number to highest.', 'kebbet-erbe-cpt-tax' ); ?></p>
		</td>
	</tr>
	<?php
}
...
function column_header( $columns ) {
	$columns['sorting'] = esc_html__( 'Sorting value', 'kebbet-erbe-cpt-tax' );
	return $columns;
}
